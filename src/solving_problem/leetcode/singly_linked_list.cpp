...
public:
  ...
  /*
          ...
          5. assgin next node of temp_ll1 to current node original, follow ruler
     of step 2.
  ...
  */
  ...
  /*
          ...
          insert the value into the set (values) and set previous to the current
     node.
  ...
  */
  ...
  /*
          - Description:
            You have a linked list where each node represents a binary digit (0
     or 1). The goal of the binaryToDecimal function is to convert this binary
     number, represented by the linked list, into its decimal equivalent.
  */
  ...
  /*
          reverses the nodes of the list from the indexes m to n (the positions
     are 0-indexed). Input: 1 -> 2 -> 3 -> 4 -> 5 => reverse_between(1, 3)
          Output: 1 -> 4 -> 3 -> 2 -> 5
